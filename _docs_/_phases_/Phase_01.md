...
> План: `_docs_/_tasks_/2026-07-27/20260727_001_WYSIWYG_Editor_idea.md` (§12)
...
2. `_docs_/_tasks_/2026-07-27/20260727_001_WYSIWYG_Editor_idea.md` — идея + ответы §16.
3. `_docs_/_checkpoints_/20260727_001_checkpoint.md` — снапшот состояния.
